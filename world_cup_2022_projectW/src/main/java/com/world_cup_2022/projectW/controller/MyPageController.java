...
public class MyPageController {
	...
	public String updateProductForm(@PathVariable String memId,
			  												  Model model) {
	...
	public String updateMyPage(MemberVO mem) {
		service.updateMyPage(mem);		
		// 수정된 데이터 저장 후 상품 조회 화면으로 포워딩  
		return "redirect:/myPage/info"; // -> 위에 있는 @RequestMapping("/product/productListAll")
	}
